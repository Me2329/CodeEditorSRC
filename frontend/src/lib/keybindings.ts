...
export const DEFAULT_BINDINGS: readonly Binding[] = [
  ...
  { command: 'edit.rename', keys: 'F2', when: 'editor' },
  { command: 'edit.comment.line', keys: 'mod+/', when: 'editor' },
  { command: 'edit.comment.block', keys: 'alt+shift+a', when: 'editor' },
  { command: 'edit.lines.moveUp', keys: 'alt+ArrowUp', when: 'editor' },
  { command: 'edit.lines.moveDown', keys: 'alt+ArrowDown', when: 'editor' },
  ...
  { command: 'files.reopen', keys: 'mod+shift+t' },
  { command: 'bookmark.toggle', keys: 'mod+alt+k' },
  { command: 'bookmark.next', keys: 'F7' },
  { command: 'bookmark.previous', keys: 'shift+F7' },
