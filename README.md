...
persisted preferences. `docs/FEATURES.md` lists all 633 with what each one does,
...
108 gateway tests, 67 assistant tests, 537 model tests and 532 frontend tests.
