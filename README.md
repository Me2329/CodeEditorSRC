...
persisted preferences. `docs/FEATURES.md` lists all 1074 with what each one does,
...
```bash
make model-doctor                      # what this machine can train and run
make model-sizes                       # eight sizes, 1.3M to 4.32B parameters
...
108 gateway tests, 71 assistant tests, 607 model tests and 561 frontend tests.
