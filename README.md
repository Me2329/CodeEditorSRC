...
persisted preferences. `docs/FEATURES.md` lists all 741 with what each one does,
...
108 gateway tests, 71 assistant tests, 596 model tests and 561 frontend tests.
