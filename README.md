...
persisted preferences. `docs/FEATURES.md` lists all 651 with what each one does,
...
108 gateway tests, 67 assistant tests, 537 model tests and 541 frontend tests.
