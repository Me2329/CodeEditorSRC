...
persisted preferences. `docs/FEATURES.md` lists all 702 with what each one does,
...
108 gateway tests, 71 assistant tests, 563 model tests and 561 frontend tests.
