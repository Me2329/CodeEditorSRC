...
persisted preferences. `docs/FEATURES.md` lists all 698 with what each one does,
...
108 gateway tests, 71 assistant tests, 561 model tests and 561 frontend tests.
