...
persisted preferences. `docs/FEATURES.md` lists all 668 with what each one does,
...
108 gateway tests, 71 assistant tests, 543 model tests and 556 frontend tests.
