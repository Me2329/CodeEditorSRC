...
persisted preferences. `docs/FEATURES.md` lists all 658 with what each one does,
...
108 gateway tests, 71 assistant tests, 538 model tests and 546 frontend tests.
