...
persisted preferences. `docs/FEATURES.md` lists all 654 with what each one does,
...
108 gateway tests, 67 assistant tests, 538 model tests and 541 frontend tests.
