...
persisted preferences. `docs/FEATURES.md` lists all 565 with what each one does,
...
100 gateway tests, 67 assistant tests, 509 model tests and 511 frontend tests.
